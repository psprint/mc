...
struct status_msg_t
{
    void *dlg;               /* pointer to status message dialog */
    ...
    void *init;         /* callback to init derived classes */
    void *update;        /* callback to update dlg */
    void *deinit;       /* callback to deinit derived classes */
};
