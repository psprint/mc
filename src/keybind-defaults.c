...
static const global_keymap_ini_t default_editor_keymap[] = {
    ...
    {"Complete", "alt-/"},
    {"MatchBracket", "alt-b"},
    {"ParagraphFormat", "alt-backslash"},
    {"Bookmark", "alt-k"},
    {"BookmarkFlush", "alt-o"},
    {"BookmarkNext", "alt-j"},
    {"BookmarkPrev", "alt-i"},
    {"MacroStartStopRecord", "ctrl-r"},
    {"MacroExecute", "ctrl-shift-a"},
    {"ShowNumbers", "alt-shift-n"},
    {"ShowTabTws", "alt-underline"},
    {"SyntaxOnOff", "ctrl-s"},
    {"Find", "alt-space"},
    {"FilePrev", "alt-minus; alt-p; alt-shift-n"},
    {"FileNext", "alt-plus; alt-n; alt-shift-p"},
    {"Sort", "alt-t"},
    {"Mail", "alt-m"},
