...
ACLOCAL = ${SHELL} /root/Dokumenty/mc-4.8.25/config/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/Dokumenty/mc-4.8.25/config/missing autoconf
AUTOHEADER = ${SHELL} /root/Dokumenty/mc-4.8.25/config/missing autoheader
AUTOMAKE = ${SHELL} /root/Dokumenty/mc-4.8.25/config/missing automake-1.16
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS =  -fdiagnostics-show-option -Wbad-function-cast -Wcomment -Wdeclaration-after-statement -Wfloat-conversion -Wfloat-equal -Wformat -Wformat-security -Wformat-signedness -Wimplicit -Wimplicit-fallthrough -Wignored-qualifiers -Wlogical-not-parentheses -Wmaybe-uninitialized -Wmissing-braces -Wmissing-declarations -Wmissing-field-initializers -Wmissing-format-attribute -Wmissing-parameter-type -Wmissing-prototypes -Wnested-externs -Wno-long-long -Wno-unreachable-code -Wparentheses -Wpointer-arith -Wpointer-sign -Wredundant-decls -Wreturn-type -Wsequence-point -Wshadow -Wsign-compare -Wstrict-prototypes -Wswitch -Wswitch-default -Wtype-limits -Wundef -Wuninitialized -Wunreachable-code -Wunused-but-set-variable -Wunused-function -Wunused-label -Wunused-parameter -Wunused-result -Wunused-value -Wunused-variable -Wwrite-strings  -std=c99
CHECK_CFLAGS = 
CHECK_LIBS = 
CP1251 = CP1251
CPP = gcc -E
CPPFLAGS =  -DENABLE_PYTHON -I/usr/include/python3.8  
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DISTR_RELEASE = 1
DISTR_VERSION = 4.8.25
DLLTOOL = false
...
DX_DVIPS = 
DX_EGREP = 
DX_ENV =  SRCDIR='/root/Dokumenty/mc-4.8.25' PROJECT='mc' DOCDIR='devel' VERSION='' HAVE_DOT='NO' GENERATE_MAN='NO' GENERATE_RTF='NO' GENERATE_XML='NO' GENERATE_HTMLHELP='NO' GENERATE_CHI='NO' GENERATE_HTML='NO' GENERATE_LATEX='NO'
DX_FLAG_chi = 0
DX_FLAG_chm = 0
DX_FLAG_doc = 0
DX_FLAG_dot = 0
...
LDFLAGS = -L/usr/lib/python3.8 -lpython3.8 -rdynamic
LIBICONV = -liconv
LIBINTL = 
LIBMC_RELEASE = 1
LIBMC_VERSION = 0.0.1
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /root/Dokumenty/mc-4.8.25/config/missing makeinfo
MANDOC = -mandoc
MANIFEST_TOOL = :
MAN_DATE = October 2020
MAN_FLAGS = -c -Tlatin1
...
X_PRE_LIBS =  -lSM -lICE
ZIP = /usr/bin/zip
abs_builddir = /root/Dokumenty/mc-4.8.25
abs_srcdir = /root/Dokumenty/mc-4.8.25
abs_top_builddir = /root/Dokumenty/mc-4.8.25
abs_top_srcdir = /root/Dokumenty/mc-4.8.25
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/Dokumenty/mc-4.8.25/config/install-sh
